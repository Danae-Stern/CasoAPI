package com.gateway.redireccion.promocion;
...
@RestController
@RequestMapping("/api/proxy/promocion")
@RequiredArgsConstructor
public class PromocionProxyController {
    ...
    public ResponseEntity<?> proxyProductos(HttpServletRequest request,
        ...
        String originalPath = request.getRequestURI().replace("/api/proxy/promocion", "");
        String targetUrl = "http://localhost:8094/api/promocion" + originalPath;
