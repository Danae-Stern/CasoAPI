package com.gateway.redireccion.detallev;
...
@RestController
@RequestMapping("/api/proxy/detalleventa")
@RequiredArgsConstructor
public class DetalleVProxyController {
    ...
    public ResponseEntity<?> proxyProductos(HttpServletRequest request,
        ...
        String originalPath = request.getRequestURI().replace("/api/proxy/detalleventa", "");
        String targetUrl = "http://localhost:8100/api/detalleventa" + originalPath;
