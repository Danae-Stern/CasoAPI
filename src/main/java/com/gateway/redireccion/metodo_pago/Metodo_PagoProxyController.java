package com.gateway.redireccion.metodo_pago;
...
@RestController
@RequestMapping("/api/proxy/metodo_pago")
@RequiredArgsConstructor
public class Metodo_PagoProxyController {
    ...
    public ResponseEntity<?> proxyProductos(HttpServletRequest request,
        ...
        String originalPath = request.getRequestURI().replace("/api/proxy/metodo_pago", "");
        String targetUrl = "http://localhost:8093/api/metodo_pago" + originalPath;
