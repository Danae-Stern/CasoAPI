...
import com.gateway.redireccion.detallev.DetalleVPublicRoutes;
...
import static com.gateway.redireccion.detallev.DetalleVPublicRoutes.*;
import static com.gateway.redireccion.envios.EnviosPublicRoutes.*;
...
import static com.gateway.redireccion.metodo_pago.Metodo_PagoPublicRoutes.*;
import static com.gateway.redireccion.pago.PagoPublicRoutes.*;
...
import static com.gateway.redireccion.promocion.PromocionPublicRoutes.*;
        ...
        return http.csrf(csrf -> csrf.disable())
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, CLIENTES_PUBLIC_GET).permitAll()   // lista pública api Clientes GET
                    ...
                    .requestMatchers(HttpMethod.GET, DETALLEV_PUBLIC_GET).permitAll()

                    .requestMatchers(HttpMethod.GET, ENVIOS_PUBLIC_GET).permitAll()

                    .requestMatchers(HttpMethod.GET, CLIENTES_PUBLIC_GET).permitAll()

                    .requestMatchers(HttpMethod.GET, INVENTARIO_PUBLIC_GET).permitAll()

                    .requestMatchers(HttpMethod.GET, METODO_PAGO_PUBLIC_GET).permitAll()

                    .requestMatchers(HttpMethod.GET, PAGO_PUBLIC_GET).permitAll()

                    .requestMatchers(HttpMethod.GET, PROMOCION_PUBLIC_GET).permitAll()

                    .requestMatchers(HttpMethod.GET, REPORTES_PUBLIC_GET).permitAll()
